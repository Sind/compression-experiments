...
int LZW_MC_find_longest_prefix(char* str, uint16_t max_length){
	...
	return -1;
//	for(i = lzw_mc_dictionary_position-1; i >= 0; i--){
//		if(lzw_mc_dictionary_sizes[i] > max_length){
//			continue;
//		}
//		int cmp = memcmp(str, dictionary+lzw_mc_dictionary_indexes[i],lzw_mc_dictionary_sizes[i]);
//		if(cmp == 0){
//			return i;
//		}
//	}
